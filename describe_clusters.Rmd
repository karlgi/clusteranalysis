  ...
  list(
    "Demographics:" = 
      list(
        ...
        "Male, n (%)"    = ~ qwraps2::n_perc0(gender == 1, na_rm = TRUE,show_denom ="always"),
        "Female, n (%)"    = ~ qwraps2::n_perc0(gender == 2, na_rm = TRUE,show_denom ="always")),
     "Registry:" =
         list(
           "Czech, n (%)"    = ~ qwraps2::n_perc0(registry == "Czech", na_rm = TRUE,show_denom ="always"),
           "FVSG, n (%)"    = ~ qwraps2::n_perc0(registry == "FVSG", na_rm = TRUE,show_denom ="always"),
           "GeVas, n (%)"    = ~ qwraps2::n_perc0(registry == "GeVas", na_rm = TRUE,show_denom ="always"),
           "POLVAS, n (%)"    = ~ qwraps2::n_perc0(registry == "Polvas", na_rm = TRUE,show_denom ="always"),
           "RKD, n (%)"    = ~ qwraps2::n_perc0(registry == "RKD", na_rm = TRUE,show_denom ="always"),
           "Skåne, n (%)"    = ~ qwraps2::n_perc0(registry == "Skåne", na_rm = TRUE,show_denom ="always")),
    
    "Diagnosis:" =
         list(
           "GPA, n (%)"    = ~ qwraps2::n_perc0(maindiagnosis == "GPA", na_rm = TRUE,show_denom ="always"),
           "MPA, n (%)"    = ~ qwraps2::n_perc0(maindiagnosis == "MPA", na_rm = TRUE,show_denom ="always")),
       "Organ Pattern:" = 
         list(
           "Musculoskeletal, n (%)"     = ~ qwraps2::n_perc0(musculoskeletal == "2", na_rm = TRUE,show_denom ="always"),
           "Cutaneous, n (%)"     = ~ qwraps2::n_perc0(cutaneous == "2", na_rm = TRUE,show_denom ="always"),
           "Eyes, n (%)"     = ~ qwraps2::n_perc0(eye == "2", na_rm = TRUE,show_denom ="always"),
           "Ear-nose-throat, n (%)"     = ~ qwraps2::n_perc0(ent == "2", na_rm = TRUE,show_denom ="always"),
           "Lung, n (%)"     = ~ qwraps2::n_perc0(chest == "2", na_rm = TRUE,show_denom ="always"),
           "Cardiovascular, n (%)"     = ~ qwraps2::n_perc0(cardio == "2", na_rm = TRUE,show_denom ="always"),
           "Abdominal, n (%)"     = ~ qwraps2::n_perc0(abdominal== "2", na_rm = TRUE,show_denom ="always"), 
           "Renal, n (%)"     = ~ qwraps2::n_perc0(kidney == "2", na_rm = TRUE,show_denom ="always"),
           "Central nervous system, n (%)"     = ~ qwraps2::n_perc0(cns == "2", na_rm = TRUE,show_denom ="always"),
           "Peripheral nervous system, n (%)"     = ~ qwraps2::n_perc0(pns == "2", na_rm = TRUE,show_denom ="always"),
           "Number of organs, mean (SD)"     = ~ qwraps2::mean_sd(nr_organs, denote_sd = "paren", na_rm = TRUE, show_n = "always")),
       "ANCA:" =
         list(
           "PR3/c-positive, n (%)"     = ~ qwraps2::n_perc0(anca == "3", na_rm = TRUE,show_denom ="always"),
           "MPO/p-positive, n (%)"     = ~ qwraps2::n_perc0(anca == "2", na_rm = TRUE,show_denom ="always"),
           "ANCA-negative, n (%)"    = ~ qwraps2::n_perc0(anca == "1", na_rm = TRUE,show_denom ="always")),
    "Laboratory:" = 
      list(
    ...
    "Cluster:" = 
      list(
        "YRS, n (%)"     = ~ qwraps2::n_perc0(index_cl == 1,show_denom ="always"),
        "SIKL, n (%)"     = ~ qwraps2::n_perc0(index_cl == 2,show_denom ="always"),
        "IMS, n (%)"     = ~ qwraps2::n_perc0(index_cl == 3,show_denom ="always"),
        "MPO-K, n (%)"     = ~ qwraps2::n_perc0(index_cl == 4,show_denom ="always"),
        "PR3-K, n (%)"     = ~ qwraps2::n_perc0(index_cl == 5,show_denom ="always")),    
    "Outcome:" = 
      list(
        "Death, n (%)"         = ~ qwraps2::n_perc0(death == TRUE, na_rm = TRUE,show_denom ="always"),
        "ESKD, n (%)"         = ~ qwraps2::n_perc0(eskd == TRUE, na_rm = TRUE,show_denom ="always"),
        "Follow up, mean (SD) years "     = ~ qwraps2::mean_sd(timeoffollowup/365.25, denote_sd = "paren", na_rm = TRUE, show_n = "always"))
  )
...
residuals_plot <- ggplot(data=residuals, aes(x=Cluster, y=Residuals, group=Registry)) +
  ...
  theme_minimal() +
  scale_x_discrete(labels = c("YRS", "SIKL", "IMS", "MPO-K", "PR3-K"))
