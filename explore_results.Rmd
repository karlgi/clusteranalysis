...
# Check mean and sd to see if they are highly skewed. 
mean_bic <- apply(avg_bic_ci[3:12], 1, FUN = mean)
sd_bic <- apply(avg_bic_ci[3:12], 1, FUN = sd)
median_bic <- apply(avg_bic_ci[3:12], 1, FUN = median)

# It is not skewed
# Make new variable of mean+/- SD
ci_low <- mean_bic-sd_bic
ci_high <- mean_bic+sd_bic
